...
public class WordSearcherTest {
    ...
    private char alphabetSoup[][] = {
        ...
        {'S','U','Q','D','N','C','N','K','O','F','S','E','C','S','Y','F','C','R','L','E','O','G','K','J','V','Q','T','E','Y','Q'},
        {'V','Z','M','Q','S','D','S','R','J','B','V','W','J','I','P','G','F','Z','Z','D','U','I','N','R','I','R','S','I','A','C'},
        {'P','F','A','Q','A','I','S','H','Y','R','D','T','Q','B','A','M','L','I','O','O','J','N','B','R','G','M','W','C','L','U'},
        {'C','J','E','O','N','P','Y','W','H','X','W','J','Q','P','H','H','K','K','B','E','G','R','M','A','Q','A','U','L','L','C'},
    ...
    @Test
    public void testEstaFabio() {
        assertTrue(!wordSearcher.isPresent("FABIO")); //FABIO esta una diagonal, pero el enunciado dice que no pueden estar en diagonal
    }
